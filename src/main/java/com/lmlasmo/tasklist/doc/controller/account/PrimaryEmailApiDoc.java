...
@SimpleApiDoc(
		summary = "Changes the primary email address",
		description = """
					Define um dos e-mails do usuário como e-mail principal.
					""",
		success = @StatusResponseApiDoc(status = 204, message = "Primary email address changed successfully"),
		errors = {
...
public @interface PrimaryEmailApiDoc {}
